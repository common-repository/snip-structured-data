...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.individual-properties--table{width:100%;border:1px solid #d3d3d3;border-collapse:collapse}.individual-properties--table th,.individual-properties--table td{padding:.5rem}.individual-properties--table .schema-property--highlighted~.schema-property--option th,.individual-properties--table .schema-property--highlighted~.schema-property--option td{border:1px solid #2a9bd9}.individual-properties--table .schema-property--highlighted~.schema-property{opacity:.2}.individual-properties--table .schema-property__name{min-width:150px}`, "",{"version":3,"sources":["webpack://./js/src/components/setup-wizard/IndividualProperties.scss"],"names":[],"mappings":"AAAA,8BAA8B,UAAU,CAAC,wBAAwB,CAAC,wBAAwB,CAAC,kEAAkE,aAAa,CAAC,gLAAgL,wBAAwB,CAAC,6EAA6E,UAAU,CAAC,qDAAqD,eAAe","sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var update = injectStylesIntoStyleTag_default()(SetupWizard/* default */.Z, options);
       ...
       /* harmony default export */ const setup_wizard_SetupWizard = (SetupWizard/* default */.Z && SetupWizard/* default */.Z.locals ? SetupWizard/* default */.Z.locals : undefined);
...
SchemaSelection_options.styleTagTransform = (styleTagTransform_default());
SchemaSelection_options.setAttributes = (setAttributesWithoutAttributes_default());

      SchemaSelection_options.insert = insertBySelector_default().bind(null, "head");
    
SchemaSelection_options.domAPI = (styleDomAPI_default());
SchemaSelection_options.insertStyleElement = (insertStyleElement_default());
...
var SchemaSelection_update = injectStylesIntoStyleTag_default()(SchemaSelection/* default */.Z, SchemaSelection_options);
       ...
       /* harmony default export */ const setup_wizard_SchemaSelection = (SchemaSelection/* default */.Z && SchemaSelection/* default */.Z.locals ? SchemaSelection/* default */.Z.locals : undefined);
...
var Loader_update = injectStylesIntoStyleTag_default()(Loader/* default */.Z, Loader_options);
       ...
       /* harmony default export */ const general_Loader = (Loader/* default */.Z && Loader/* default */.Z.locals ? Loader/* default */.Z.locals : undefined);
...
function Loader_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) Loader_setPrototypeOf(subClass, superClass); }
function Loader_setPrototypeOf(o, p) { Loader_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Loader_setPrototypeOf(o, p); }
...
function Loader_possibleConstructorReturn(self, call) { if (call && (Loader_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return Loader_assertThisInitialized(self); }
...
function Loader_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function Loader_getPrototypeOf(o) { Loader_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Loader_getPrototypeOf(o); }
...
SchemaChooser_options.styleTagTransform = (styleTagTransform_default());
SchemaChooser_options.setAttributes = (setAttributesWithoutAttributes_default());

      SchemaChooser_options.insert = insertBySelector_default().bind(null, "head");
    
SchemaChooser_options.domAPI = (styleDomAPI_default());
SchemaChooser_options.insertStyleElement = (insertStyleElement_default());
...
var SchemaChooser_update = injectStylesIntoStyleTag_default()(SchemaChooser/* default */.Z, SchemaChooser_options);
       ...
       /* harmony default export */ const setup_wizard_SchemaChooser = (SchemaChooser/* default */.Z && SchemaChooser/* default */.Z.locals ? SchemaChooser/* default */.Z.locals : undefined);
...
var Accordion_update = injectStylesIntoStyleTag_default()(Accordion/* default */.Z, Accordion_options);
       ...
       /* harmony default export */ const general_Accordion = (Accordion/* default */.Z && Accordion/* default */.Z.locals ? Accordion/* default */.Z.locals : undefined);
...
function Accordion_setPrototypeOf(o, p) { Accordion_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Accordion_setPrototypeOf(o, p); }
...
function Accordion_getPrototypeOf(o) { Accordion_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Accordion_getPrototypeOf(o); }
...
function SchemaChooser_typeof(o) { "@babel/helpers - typeof"; return SchemaChooser_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, SchemaChooser_typeof(o); }
...
function SchemaChooser_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, SchemaChooser_toPropertyKey(descriptor.key), descriptor); } }
function SchemaChooser_createClass(Constructor, protoProps, staticProps) { if (protoProps) SchemaChooser_defineProperties(Constructor.prototype, protoProps); if (staticProps) SchemaChooser_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function SchemaChooser_toPropertyKey(arg) { var key = SchemaChooser_toPrimitive(arg, "string"); return SchemaChooser_typeof(key) === "symbol" ? key : String(key); }
function SchemaChooser_toPrimitive(input, hint) { if (SchemaChooser_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SchemaChooser_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SchemaChooser_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) SchemaChooser_setPrototypeOf(subClass, superClass); }
function SchemaChooser_setPrototypeOf(o, p) { SchemaChooser_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SchemaChooser_setPrototypeOf(o, p); }
...
function SchemaChooser_possibleConstructorReturn(self, call) { if (call && (SchemaChooser_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return SchemaChooser_assertThisInitialized(self); }
...
function SchemaChooser_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function SchemaChooser_getPrototypeOf(o) { SchemaChooser_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SchemaChooser_getPrototypeOf(o); }
...
IndividualProperties_options.styleTagTransform = (styleTagTransform_default());
IndividualProperties_options.setAttributes = (setAttributesWithoutAttributes_default());

      IndividualProperties_options.insert = insertBySelector_default().bind(null, "head");
    
IndividualProperties_options.domAPI = (styleDomAPI_default());
IndividualProperties_options.insertStyleElement = (insertStyleElement_default());
...
var IndividualProperties_update = injectStylesIntoStyleTag_default()(IndividualProperties/* default */.Z, IndividualProperties_options);
       ...
       /* harmony default export */ const setup_wizard_IndividualProperties = (IndividualProperties/* default */.Z && IndividualProperties/* default */.Z.locals ? IndividualProperties/* default */.Z.locals : undefined);

;// CONCATENATED MODULE: ./js/src/components/setup-wizard/IndividualProperties.js
function IndividualProperties_typeof(o) { "@babel/helpers - typeof"; return IndividualProperties_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, IndividualProperties_typeof(o); }
...
function IndividualProperties_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function IndividualProperties_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, IndividualProperties_toPropertyKey(descriptor.key), descriptor); } }
function IndividualProperties_createClass(Constructor, protoProps, staticProps) { if (protoProps) IndividualProperties_defineProperties(Constructor.prototype, protoProps); if (staticProps) IndividualProperties_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function IndividualProperties_toPropertyKey(arg) { var key = IndividualProperties_toPrimitive(arg, "string"); return IndividualProperties_typeof(key) === "symbol" ? key : String(key); }
function IndividualProperties_toPrimitive(input, hint) { if (IndividualProperties_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (IndividualProperties_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function IndividualProperties_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) IndividualProperties_setPrototypeOf(subClass, superClass); }
function IndividualProperties_setPrototypeOf(o, p) { IndividualProperties_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return IndividualProperties_setPrototypeOf(o, p); }
...
function IndividualProperties_possibleConstructorReturn(self, call) { if (call && (IndividualProperties_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return IndividualProperties_assertThisInitialized(self); }
...
function IndividualProperties_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function IndividualProperties_getPrototypeOf(o) { IndividualProperties_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return IndividualProperties_getPrototypeOf(o); }
...
SchemaRuleset_options.styleTagTransform = (styleTagTransform_default());
SchemaRuleset_options.setAttributes = (setAttributesWithoutAttributes_default());

      SchemaRuleset_options.insert = insertBySelector_default().bind(null, "head");
    
SchemaRuleset_options.domAPI = (styleDomAPI_default());
SchemaRuleset_options.insertStyleElement = (insertStyleElement_default());
...
var SchemaRuleset_update = injectStylesIntoStyleTag_default()(SchemaRuleset/* default */.Z, SchemaRuleset_options);
       ...
       /* harmony default export */ const components_SchemaRuleset = (SchemaRuleset/* default */.Z && SchemaRuleset/* default */.Z.locals ? SchemaRuleset/* default */.Z.locals : undefined);
...
SchemaRuleGroup_options.styleTagTransform = (styleTagTransform_default());
SchemaRuleGroup_options.setAttributes = (setAttributesWithoutAttributes_default());

      SchemaRuleGroup_options.insert = insertBySelector_default().bind(null, "head");
    
SchemaRuleGroup_options.domAPI = (styleDomAPI_default());
SchemaRuleGroup_options.insertStyleElement = (insertStyleElement_default());
...
var SchemaRuleGroup_update = injectStylesIntoStyleTag_default()(SchemaRuleGroup/* default */.Z, SchemaRuleGroup_options);
       ...
       /* harmony default export */ const components_SchemaRuleGroup = (SchemaRuleGroup/* default */.Z && SchemaRuleGroup/* default */.Z.locals ? SchemaRuleGroup/* default */.Z.locals : undefined);
...
SchemaRule_options.styleTagTransform = (styleTagTransform_default());
SchemaRule_options.setAttributes = (setAttributesWithoutAttributes_default());

      SchemaRule_options.insert = insertBySelector_default().bind(null, "head");
    
SchemaRule_options.domAPI = (styleDomAPI_default());
SchemaRule_options.insertStyleElement = (insertStyleElement_default());
...
var SchemaRule_update = injectStylesIntoStyleTag_default()(SchemaRule/* default */.Z, SchemaRule_options);
       ...
       /* harmony default export */ const components_SchemaRule = (SchemaRule/* default */.Z && SchemaRule/* default */.Z.locals ? SchemaRule/* default */.Z.locals : undefined);
...
var emotion_use_insertion_effect_with_fallbacks_browser_esm_useInsertionEffectWithLayoutFallback = useInsertionEffect || external_React_namespaceObject.useLayoutEffect;
...
var EmotionCacheContext = /* #__PURE__ */external_React_namespaceObject.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
  ...
  emotion_element_c39617d8_browser_esm_withEmotionCache = function withEmotionCache(func) {
    return function (props) {
      ...
      if (cache === null) {
        ...
        return /*#__PURE__*/external_React_namespaceObject.createElement(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var emotion_element_c39617d8_browser_esm_ThemeContext = /* #__PURE__ */external_React_namespaceObject.createContext({});
...
var Emotion = /* #__PURE__ */emotion_element_c39617d8_browser_esm_withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = emotion_serialize_browser_esm_serializeStyles(registeredStyles, undefined, external_React_namespaceObject.useContext(emotion_element_c39617d8_browser_esm_ThemeContext));
...
var index =  external_React_namespaceObject.useLayoutEffect ;
...
if (w.addEventListener && w.removeEventListener) {
  w.addEventListener('p', noop, index_baa8dc4f_esm_options);
...
var MenuPlacer = function MenuPlacer(props) {
  var children = props.children,
    ...
    theme = props.theme;
  var _ref3 = (0,external_React_namespaceObject.useContext)(PortalPlacementContext) || {},
    setPortalPlacement = _ref3.setPortalPlacement;
  var ref = (0,external_React_namespaceObject.useRef)(null);
  var _useState = (0,external_React_namespaceObject.useState)(maxMenuHeight),
...
var MenuPortal = function MenuPortal(props) {
  ...
  var _useState5 = (0,external_React_namespaceObject.useState)(coercePlacement(menuPlacement)),
  ...
  }, appendTo ? /*#__PURE__*/(0,external_ReactDOM_.createPortal)(menuWrapper, appendTo) : menuWrapper);
};
  ...
  function Select(_props) {
    ...
    _this.selectOption = function (newValue) {
      ...
      if (deselected) {
        ...
        if (isMulti) {
          _this.setValue(multiValueAsValue([].concat(toConsumableArray_toConsumableArray(selectValue), [newValue])), 'select-option', newValue);
        } else {
...
function useStateManager(_ref) {
  ...
  var _useState = (0,external_React_namespaceObject.useState)(propsInputValue !== undefined ? propsInputValue : defaultInputValue),
    _useState2 = _slicedToArray(_useState, 2),
    stateInputValue = _useState2[0],
    setStateInputValue = _useState2[1];
  var _useState3 = (0,external_React_namespaceObject.useState)(propsMenuIsOpen !== undefined ? propsMenuIsOpen : defaultMenuIsOpen),
    _useState4 = _slicedToArray(_useState3, 2),
    stateMenuIsOpen = _useState4[0],
    setStateMenuIsOpen = _useState4[1];
  var _useState5 = (0,external_React_namespaceObject.useState)(propsValue !== undefined ? propsValue : defaultValue),
    _useState6 = _slicedToArray(_useState5, 2),
    stateValue = _useState6[0],
    setStateValue = _useState6[1];
  var onChange = (0,external_React_namespaceObject.useCallback)(function (value, actionMeta) {
    if (typeof propsOnChange === 'function') {
      propsOnChange(value, actionMeta);
    }
    setStateValue(value);
  }, [propsOnChange]);
  var onInputChange = (0,external_React_namespaceObject.useCallback)(function (value, actionMeta) {
    var newValue;
...
;// CONCATENATED MODULE: ./node_modules/react-select/dist/useAsync-85924129.esm.js
...
var useAsync_85924129_esm_excluded = ["defaultOptions", "cacheOptions", "loadOptions", "options", "isLoading", "onInputChange", "filterOption"];
function useAsync(_ref) {
  var _ref$defaultOptions = _ref.defaultOptions,
    ...
    restSelectProps = _objectWithoutProperties(_ref, useAsync_85924129_esm_excluded);
  var propsInputValue = restSelectProps.inputValue;
  var lastRequest = (0,external_React_namespaceObject.useRef)(undefined);
  var mounted = (0,external_React_namespaceObject.useRef)(false);
  var _useState = (0,external_React_namespaceObject.useState)(Array.isArray(propsDefaultOptions) ? propsDefaultOptions : undefined),
    _useState2 = _slicedToArray(_useState, 2),
    defaultOptions = _useState2[0],
    setDefaultOptions = _useState2[1];
  var _useState3 = (0,external_React_namespaceObject.useState)(typeof propsInputValue !== 'undefined' ? propsInputValue : ''),
    _useState4 = _slicedToArray(_useState3, 2),
    stateInputValue = _useState4[0],
    setStateInputValue = _useState4[1];
  var _useState5 = (0,external_React_namespaceObject.useState)(propsDefaultOptions === true),
    _useState6 = _slicedToArray(_useState5, 2),
    isLoading = _useState6[0],
    setIsLoading = _useState6[1];
  var _useState7 = (0,external_React_namespaceObject.useState)(undefined),
    _useState8 = _slicedToArray(_useState7, 2),
  ...
  var _useState11 = (0,external_React_namespaceObject.useState)(false),
  ...
  var _useState15 = (0,external_React_namespaceObject.useState)(undefined),
    _useState16 = _slicedToArray(_useState15, 2),
    prevDefaultOptions = _useState16[0],
    setPrevDefaultOptions = _useState16[1];
  var _useState17 = (0,external_React_namespaceObject.useState)(undefined),
  ...
  var loadOptions = (0,external_React_namespaceObject.useCallback)(function (inputValue, callback) {
  ...
  var onInputChange = (0,external_React_namespaceObject.useCallback)(function (newValue, actionMeta) {
    ...
    if (cacheOptions && optionsCache[inputValue]) {
      ...
      loadOptions(inputValue, function (options) {
        ...
        setPassEmptyOptions(false);
        setOptionsCache(options ? objectSpread2_objectSpread2(objectSpread2_objectSpread2({}, optionsCache), {}, _defineProperty({}, inputValue, options)) : optionsCache);
      });
    }
...
var AsyncSelect = /*#__PURE__*/(0,external_React_namespaceObject.forwardRef)(function (props, ref) {
...
function rules_typeof(o) { "@babel/helpers - typeof"; return rules_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, rules_typeof(o); }
...
function rules_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function rules_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, rules_toPropertyKey(descriptor.key), descriptor); } }
function rules_createClass(Constructor, protoProps, staticProps) { if (protoProps) rules_defineProperties(Constructor.prototype, protoProps); if (staticProps) rules_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function rules_defineProperty(obj, key, value) { key = rules_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function rules_toPropertyKey(arg) { var key = rules_toPrimitive(arg, "string"); return rules_typeof(key) === "symbol" ? key : String(key); }
function rules_toPrimitive(input, hint) { if (rules_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (rules_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
var Rule = /*#__PURE__*/rules_createClass(function Rule(param, operator, value) {
...
function SchemaRule_typeof(o) { "@babel/helpers - typeof"; return SchemaRule_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, SchemaRule_typeof(o); }
function SchemaRule_ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function SchemaRule_objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? SchemaRule_ownKeys(Object(t), !0).forEach(function (r) { SchemaRule_defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : SchemaRule_ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function SchemaRule_defineProperty(obj, key, value) { key = SchemaRule_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function SchemaRule_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, SchemaRule_toPropertyKey(descriptor.key), descriptor); } }
function SchemaRule_createClass(Constructor, protoProps, staticProps) { if (protoProps) SchemaRule_defineProperties(Constructor.prototype, protoProps); if (staticProps) SchemaRule_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function SchemaRule_toPropertyKey(arg) { var key = SchemaRule_toPrimitive(arg, "string"); return SchemaRule_typeof(key) === "symbol" ? key : String(key); }
function SchemaRule_toPrimitive(input, hint) { if (SchemaRule_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SchemaRule_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SchemaRule_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) SchemaRule_setPrototypeOf(subClass, superClass); }
function SchemaRule_setPrototypeOf(o, p) { SchemaRule_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SchemaRule_setPrototypeOf(o, p); }
...
function SchemaRule_possibleConstructorReturn(self, call) { if (call && (SchemaRule_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return SchemaRule_assertThisInitialized(self); }
...
function SchemaRule_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function SchemaRule_getPrototypeOf(o) { SchemaRule_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SchemaRule_getPrototypeOf(o); }
...
var SchemaRule_SchemaRule = /*#__PURE__*/function (_React$Component) {
  ...
  SchemaRule_createClass(SchemaRule, [{
    ...
    value: function render() {
      ...
      if (isSelect2) {
        valueBlock = wp.element.createElement(AsyncSelect$1, {
          cacheOptions: true,
...
function SchemaRulegroup_typeof(o) { "@babel/helpers - typeof"; return SchemaRulegroup_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, SchemaRulegroup_typeof(o); }
...
function SchemaRulegroup_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, SchemaRulegroup_toPropertyKey(descriptor.key), descriptor); } }
function SchemaRulegroup_createClass(Constructor, protoProps, staticProps) { if (protoProps) SchemaRulegroup_defineProperties(Constructor.prototype, protoProps); if (staticProps) SchemaRulegroup_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function SchemaRulegroup_toPropertyKey(arg) { var key = SchemaRulegroup_toPrimitive(arg, "string"); return SchemaRulegroup_typeof(key) === "symbol" ? key : String(key); }
function SchemaRulegroup_toPrimitive(input, hint) { if (SchemaRulegroup_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SchemaRulegroup_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SchemaRulegroup_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) SchemaRulegroup_setPrototypeOf(subClass, superClass); }
function SchemaRulegroup_setPrototypeOf(o, p) { SchemaRulegroup_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SchemaRulegroup_setPrototypeOf(o, p); }
...
function SchemaRulegroup_possibleConstructorReturn(self, call) { if (call && (SchemaRulegroup_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return SchemaRulegroup_assertThisInitialized(self); }
...
function SchemaRulegroup_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function SchemaRulegroup_getPrototypeOf(o) { SchemaRulegroup_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SchemaRulegroup_getPrototypeOf(o); }
...
function SchemaRuleset_typeof(o) { "@babel/helpers - typeof"; return SchemaRuleset_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, SchemaRuleset_typeof(o); }
...
function SchemaRuleset_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, SchemaRuleset_toPropertyKey(descriptor.key), descriptor); } }
function SchemaRuleset_createClass(Constructor, protoProps, staticProps) { if (protoProps) SchemaRuleset_defineProperties(Constructor.prototype, protoProps); if (staticProps) SchemaRuleset_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function SchemaRuleset_toPropertyKey(arg) { var key = SchemaRuleset_toPrimitive(arg, "string"); return SchemaRuleset_typeof(key) === "symbol" ? key : String(key); }
function SchemaRuleset_toPrimitive(input, hint) { if (SchemaRuleset_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SchemaRuleset_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SchemaRuleset_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) SchemaRuleset_setPrototypeOf(subClass, superClass); }
function SchemaRuleset_setPrototypeOf(o, p) { SchemaRuleset_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SchemaRuleset_setPrototypeOf(o, p); }
...
function SchemaRuleset_possibleConstructorReturn(self, call) { if (call && (SchemaRuleset_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return SchemaRuleset_assertThisInitialized(self); }
...
function SchemaRuleset_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function SchemaRuleset_getPrototypeOf(o) { SchemaRuleset_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SchemaRuleset_getPrototypeOf(o); }
...
function IndividualRules_typeof(o) { "@babel/helpers - typeof"; return IndividualRules_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, IndividualRules_typeof(o); }
...
function IndividualRules_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function IndividualRules_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, IndividualRules_toPropertyKey(descriptor.key), descriptor); } }
function IndividualRules_createClass(Constructor, protoProps, staticProps) { if (protoProps) IndividualRules_defineProperties(Constructor.prototype, protoProps); if (staticProps) IndividualRules_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function IndividualRules_toPropertyKey(arg) { var key = IndividualRules_toPrimitive(arg, "string"); return IndividualRules_typeof(key) === "symbol" ? key : String(key); }
function IndividualRules_toPrimitive(input, hint) { if (IndividualRules_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (IndividualRules_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function IndividualRules_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) IndividualRules_setPrototypeOf(subClass, superClass); }
function IndividualRules_setPrototypeOf(o, p) { IndividualRules_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return IndividualRules_setPrototypeOf(o, p); }
...
function IndividualRules_possibleConstructorReturn(self, call) { if (call && (IndividualRules_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return IndividualRules_assertThisInitialized(self); }
...
function IndividualRules_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function IndividualRules_getPrototypeOf(o) { IndividualRules_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return IndividualRules_getPrototypeOf(o); }
...
function SetupWizard_typeof(o) { "@babel/helpers - typeof"; return SetupWizard_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, SetupWizard_typeof(o); }
...
function SetupWizard_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function SetupWizard_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, SetupWizard_toPropertyKey(descriptor.key), descriptor); } }
function SetupWizard_createClass(Constructor, protoProps, staticProps) { if (protoProps) SetupWizard_defineProperties(Constructor.prototype, protoProps); if (staticProps) SetupWizard_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function SetupWizard_toPropertyKey(arg) { var key = SetupWizard_toPrimitive(arg, "string"); return SetupWizard_typeof(key) === "symbol" ? key : String(key); }
function SetupWizard_toPrimitive(input, hint) { if (SetupWizard_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SetupWizard_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SetupWizard_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) SetupWizard_setPrototypeOf(subClass, superClass); }
function SetupWizard_setPrototypeOf(o, p) { SetupWizard_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SetupWizard_setPrototypeOf(o, p); }
...
function SetupWizard_possibleConstructorReturn(self, call) { if (call && (SetupWizard_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return SetupWizard_assertThisInitialized(self); }
...
function SetupWizard_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function SetupWizard_getPrototypeOf(o) { SetupWizard_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SetupWizard_getPrototypeOf(o); }
      ...
      switch (this.state.step) {
        ...
        case 9:
          block = wp.element.createElement("div", {
            ...
            type: "hidden",
            name: "locale",
            value: SetupWizardConfig.userLanguage
          }), wp.element.createElement("input", {
            type: "hidden",
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,client/* createRoot */.s)(entry).render(wp.element.createElement(components_setup_wizard_SetupWizard, null));
});
})();
